...
export const getLinkedInUploadProps = (setLinkedInPageProps, form, setLinkedInPageUpdated) => {
  return {
    beforeUpload: (file) => {
      const isAllowedType = [
        "application/pdf",
...
export const getCoverLetterUploadProps = (setCoverLetterProps, form, setCoverLetterUpdated) => {
  return {
    beforeUpload: (file) => {
      const isAllowedType = [
        "application/pdf",
