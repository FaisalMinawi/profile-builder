...
describe("Profile Controller", () => {
  ...
  describe("updateProfile", () => {
    it("should update a profile and return the updated profile", async () => {
      ...
      const response = await request(app).put("/profile/test-slug").send({ name: "Test User", age: 30 });
    ...
    it("should return 404 if profile not found", async () => {
      ProfileService.updateProfile.mockRejectedValue(new Error("Profile not found"));
